...
GLuint uniformXMove; // a uniform variable that tells us how much to move left and right.
...
float triIncrement = 0.0005f; // How much to move the offset.
...
// xMove is a uniform variable will be kept the same for each coordinate. So one value across the coordinates.
...
void CompileShaders()
{
    ...
    uniformXMove = glGetUniformLocation(shader, // Program to get the variable from
        "xMove"); // Name of the variable in the program.
}
